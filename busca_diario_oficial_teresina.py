...
while(url_address != ''):
	url = requests.get('{}/{}'.format('http://www.dom.teresina.pi.gov.br',url_address))
	...
	for pdf in pdfs:
		...
		if not os.path.exists(local_pdf):
			response = urllib2.urlopen(urllib2.Request(pdf)).read()
	...
	url_address = tree.xpath('//p[@class="box-paginacao"]/span[@class="label"]/a/@href')[0]